                    ...
                    <tbody>
                        ...
                        @foreach ($drivers as $driver)
                            <tr>
                                ...
                                <td class="capitalize">{{ $driver->name }}</td>
                                <td class="uppercase">{{ $driver->phone }}</td>
                                <td class="text-center">
                                    @if ($driver->status == 'tersedia')
                                        <span
                                            class=" bg-green-500 px-2.5 py-1.5 rounded-xl text-white text-xs">Tersedia</span>
                                    @else
                                        <span class="bg-red-500 px-2.5 py-1.5 rounded-xl text-white text-xs text-nowrap">
                                            Tidak Tersedia
                                        </span>
                                    @endif
                                </td>
                                ...
                                <td class="flex items-center space-x-2">
                                    <button data-id="{{ $driver->id }}" data-jenis="edit"
                                    ...
                                    <button data-id="{{ $driver->id }}" data-jenis="delete"
...
@push('scripts')
    <script>
        // Datatables
        if (document.getElementById("drivers-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#drivers-table", {
                searchable: true,
            });
        }
    </script>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            $('#drivers-table').on('click', '.action', function() {
                let data = $(this).data();
                let id = data.id;
